                    ...
                    <div class="container">
						...
						<div class="col-sm-6">
                                <div class="contact-form">
                                	<h4>Latest Course Materials for You</h4>
                        	...
                        	<div class="col-sm-6">
                                <div class="contact-form">
                                    ...
                                    <form name="form" action="materialSearchHomeStudent" method="post">
                                    ...
                                    <form name="form" action="materialViewAllStudent" method="post">
                                    <br>
