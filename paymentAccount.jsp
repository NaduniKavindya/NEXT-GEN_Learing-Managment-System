                ...
                <div class="contact wow bounceInRight" data-wow-delay="0.4s">
                    <div class="container">
                        <div class="row">
                                    ...
                                    <a href="${pay.img}" download="${pay.img}">DOWNLOAD SLIP </a>
                                    </tr>
    					  ...
    					  <c:param name ="IMG" value="${sliP}"/>
                           ...
                           <a href="${Upayment}">
	 							<button type="submit"   class="btn wow bounceInRight" data-wow-delay="0.8s" name="updste" value="updste">UPDATE </button>
						</a>  
                           
                           <a href="${Dpayment}">
	 							<button type="submit"   class="btn wow bounceInRight" data-wow-delay="0.8s" name="DELEAT" value="DELEAT">DELETE </button>
						</a>  
