                    ...
                    <div class="container">
                        ...
                        <div class="col-sm-6">
                                <div class="contact-form">
                                 <form action="materialSearchStudent" method="post">
							<a href="materialSearchStudent.jsp"><button type="button" class="btn wow bounceInRight">Try Another Search</button></a>
							</form>
							<br><br>
							...
							<form action="materialViewLatestStudent" method="post">
