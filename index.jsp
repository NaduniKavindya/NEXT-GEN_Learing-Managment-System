                  ...
                  <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="page-scroll" href="login1.jsp">login</a></li>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>Who We Are?</h4>
                                        <p>
                                            Leading educational institution located in Galewela ,Sri lanka which conducts extra classes for students in all grades providing them with all the necessary resources.
                                        </p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.2s">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>What We Do?</h4>
                                        <p>
                                            Provide the necessary academic activities for students in any part of Sri Lanka. We have the best set of teachers to conduct our academic activities.
                                        </p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.4s">
                                    ...
                                    <div class="rotate-box-info">
                                        <h4>Why We Do It?</h4>
                                        <p>
                                            We need to produce the best set of citizens with highest educational qualifications to get to the apex positions in society.
                                        </p>
                                    </div>
                                </a>
                            </div>
                    	...
                    	<div class="row">
                        	...
                        	<div class="col-sm-6">
                                <div class="skill-bar wow slideInLeft" data-wow-delay="0.2s">
                                    ...
                                    <div class="progress">
                                      <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 80%;">
                                      </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.4s">
                                    <span class="rotate-box-icon"><i class="fa fa-pencil"></i></span>
                                    <div class="rotate-box-info">
                                        <h4>Additional reading materials</h4>
                ...
                <div class="page-header-wrapper">
                    <div class="container">
                        <div class="page-header text-center wow fadeInDown" data-wow-delay="0.4s">
                            <h2>Our Team</h2>
                            <div class="devider"></div>
                            <p class="subtitle">Meat our team</p>
                        </div>
                    </div>
                </div>
                <!-- End page header-->
                                ...
                                <div class="team-container wow bounceIn" data-wow-delay="0.2s">
                                    <div class="team-item">
                                        <div class="team-triangle">
                                            <div class="content">
                                                <img src="img/team/indikaSIR.JPG" alt="title"/>
			...
			<section id="social-section">
                ...
                <div class="container">
                	<ul class="social-list">
                		<li> <a href="https://www.facebook.com/indika.hearth" class="rotate-box-1 square-icon text-center wow zoomIn" data-wow-delay="0.3s"><span class="rotate-box-icon"><i class="fa fa-facebook"></i></span></a></li>
