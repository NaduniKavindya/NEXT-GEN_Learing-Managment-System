...
<html lang="en-US">
				...
				<div class="container">
					<div class="caption text-center text-white" data-stellar-ratio="0.7">
						...
						<div id="owl-intro-text" class="owl-carousel">
							<div class="item">
								<h2>උසස් පෙළට  ICT හඳුන්වා දුන් 2011  සිට මාතලේ දිස්ත්‍රික්කය තුළ පන්තියක      
                                   වාර්තා වුණු වැඩිම A සාමාර්ථ ලබා ගැනීමට මඟ පෙන්වූ ගුරුවරයාගෙන් ලංකාවම online</h2>
							...
							<div class="item">
								<h2>ICT உயர்தர நிலைக்கு அறிமுகப்படுத்தப்பட்ட 2011 முதல் மாத்தளை மாவட்டத்தில் ஒரு வகுப்பு
                                   ஆன்லைனில் இலங்கையில் அதிக எண்ணிக்கையிலான ஏ பாஸ் பதிவு செய்ய எனக்கு வழிகாட்டிய ஆசிரியரிடமிருந்து</h2>
    ...
    <!--    Begin Services -->
             <section id="payment-section" class="page text-white parallax" data-stellar-background-ratio="0.5">
                <!-- Begin page header-->
                <div class="page-header-wrapper">
                    <div class="container">
                        <div class="page-header text-center wow fadeInDown" data-wow-delay="0.4s">
                            ...
                            <p class="subtitle">More Academic Materials</p>
                        </div>
                    </div>
                </div>
...
String connectionUrl = "jdbc:postgresql://localhost:5432/student_info";
...
%>
<h2 align="center"><font><strong>PACKAGES THAT WE HAVE</strong></font></h2><br><br><br><br>
...
String sql ="SELECT * FROM student_info.packages WHERE uname like'%English%'";
        ...
        $("body").on("click", "#btnExport", function () {
            html2canvas($('#tblCustomers')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("English.pdf");
                }
            });
        });
    </script>
