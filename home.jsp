...
<html>
    ...
    <body data-spy="scroll" data-target="#main-navbar">
    	...
    	<div class="body">
			...
			<section id="text-carousel-intro-section" class="parallax" data-stellar-background-ratio="0.5" style="background-image: url(img/BG.png);">
				...
				<div class="container">
					<div class="caption text-center text-white" data-stellar-ratio="0.7">
						...
						<div id="owl-intro-text" class="owl-carousel">
							<div class="item">
								<h2>A class in the Matale District since 2011 when ICT was introduced to the Advanced Level
                                   From the teacher who guided to get the highest number of A passes recorded in Sri Lanka </h2>
                ...
                <div class="rotate-box-2-wrapper">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="noticeViewAll.jsp" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.2s">
                                    <span class="rotate-box-icon"><i class="fa fa-pencil"></i></span>
                                    <div class="rotate-box-info">
                                        <h4>NOTICES</h4>
                            ...
                            <div class="col-md-3 col-sm-6"><form id="GFG" action = "materialViewLatestStudent" method = "post">
                                <a href="#" onclick="materialPage()" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.4s">
                                    <span class="rotate-box-icon"><i class="fa fa-pencil"></i></span>
                                    <div class="rotate-box-info">
                                        <h4 type="submit">Additional reading materials</h4>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="packages.jsp" class="rotate-box-2 square-icon text-center wow zoomIn" data-wow-delay="0.6s">
                                    <span class="rotate-box-icon"><i class="fa fa-pencil"></i></span>
                                    <div class="rotate-box-info">
                                        <h4>Extra Study packages</h4>
                        ...
                        <div class="col-md-12">
                            <div class="portfolio">
                                ...
                                <div class="page-header-wrapper">
                                    <div class="container">
                                        <div class="page-header text-center wow fadeInDown" data-wow-delay="0.4s">
                                            <h2>YouTube tutorials for Information Technology.</h2>
                                            <div class="devider"></div>
                                            <p class="subtitle">Learn from us</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End page header-->
                                <div class="portfoloi_content_area" >
                                    <div class="portfolio_menu" id="filters">
                                        <ul>
                                            ...
                                            <li><a href="#porfolio_menu" data-filter=".websites">COMMUNICATION AND NETWORKING</a></li>
                                            <li><a href="#porfolio_menu" data-filter=".webDesign" >HTML</a></li>
                                            <li><a href="#porfolio_menu" data-filter=".appsDevelopment">PHP </a></li>
                                            <li><a href="#porfolio_menu" data-filter=".GraphicDesign">OPARATING SYSTEM</a></li>
                                            <li><a href="#porfolio_menu" data-filter=".responsive">INTERNET</a></li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="row"  id="portfolio">
                                            <div class="col-xs-12 col-sm-4 appsDevelopment">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/php.png" alt="title"/>
                                                    <div>
                                                        <a href="https://www.youtube.com/watch?v=dq8eqDQm0Hc&list=PLiy2koCEa4fy_iGJIKRxXx8W6nfIsOMS1">PHP</a>
                                                        <span> . </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 GraphicDesign">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/O1.jpg" alt="title"/>
                                                    <div>
                                                        <a href="https://www.youtube.com/watch?v=43bb9d1KxlI&list=PLiy2koCEa4fzQt_JhfsuDfHRlbvwg5Sb2">Oparating system</a>
                                                        <span> . </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 responsive">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/WEB.jpg" alt="title"/>
                                                    <div>
                                                        <a href="https://www.youtube.com/watch?v=tJZzEBH8Mag&list=PLiy2koCEa4fxab4F5GmDcWULmqMscPMyd">Internet</a>
                                                        <span> . </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-4 webDesign">
                                                <div class="portfolio_single_content">
                                                    ...
                                                    <div>
                                                        <a href="https://www.youtube.com/watch?v=0qYUJcdGY5I&list=PLiy2koCEa4fz-JPHcFvPyeGtRuFC2GL66">HTML</a>
                                                        <span> . </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-4 websites">
                                                <div class="portfolio_single_content">
                                                    <img src="img/portfolio/c11.jpg" alt="title"/>
                                                    <div>
                                                        <a href="https://www.youtube.com/watch?v=yL3i68X-b-o&list=PLiy2koCEa4fwb-LuAdiiQjiI_lAHngx9N">COMMUNICATION AND NETWORKING</a>
                                                        <span> . </span>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="page-header-wrapper">
                    <div class="container">
                        <div class="page-header text-center wow fadeInDown" data-wow-delay="0.4s">
                            <h2>Package</h2>
                            <div class="devider"></div>
                            <p class="subtitle">Supplementary Stuff</p>
                        </div>
                    </div>
                </div>
                <!-- End page header-->
						...
						<div class="row">
							...
							<div class="price-box col-sm-6 col-md-3 wow flipInY" data-wow-delay="0.3s">
								<div class="panel panel-default">
									...
									<div class="panel-body text-center">
										<p class="lead"><strong>I C T</strong></p>
									</div>
									...
									<div class="panel-footer text-center">
										<a class="btn btn-default" href="payment.jsp">Order Now!</a>
									</div>
								</div>										
							</div>
							...
							<div class="price-box col-sm-6 col-md-3 wow flipInY" data-wow-delay="0.5s">
								<div class="panel panel-default">
									...
									<div class="panel-body text-center">
										<p class="lead"><strong>English</strong></p>
									</div>
									<ul class="list-group text-center">
										<li class="list-group-item">Grammar</li>
										<li class="list-group-item">Vocabulary</li>
										<li class="list-group-item">IELTS</li>
										<li class="list-group-item">FCE</li>
										<li class="list-group-item">Support</li>
									</ul>
									<div class="panel-footer text-center">
										<a class="btn btn-default" href="payment.jsp">Order Now!</a>
						  ...
						  <div class="price-box col-sm-6 col-md-3 wow flipInY" data-wow-delay="0.5s">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body text-center">
                                        <p class="lead"><strong>Maths</strong></p>
                                    </div>
                                    <ul class="list-group text-center">
                                        <li class="list-group-item">Simple maths</li>
							...
							<div class="price-box col-sm-6 col-md-3 wow flipInY" data-wow-delay="0.9s">
								<div class="panel panel-default">
									...
									<div class="panel-body text-center">
										<p class="lead"><strong> More</strong></p>
									</div>
									<ul class="list-group text-center">
									...
									<div class="panel-footer text-center">
										<a class="btn btn-default" href="packages.jsp">Order Now!</a>
									</div>
								</div>										
							</div>
                          ...
                          <div class="col-sm-6">
                                <div class="contact-info">
                                    ...
                                    <ul class="contact-address">
			                              <li><i class="fa fa-print"></i>&nbsp;Sampath bank= 066 ** ** ***</li>
                                        <li><i class="fa fa-print"></i>&nbsp;Comerschel banl= 066 ** ** ***</li>
                                        <li><i class="fa fa-print"></i>&nbsp;Pepols bank= 066 ** ** ***</li>
                                        <li><i class="fa fa-print"></i>&nbsp;HNB bank= 066 ** ** ***</li> 
			                            <li><i class="fa fa-envelope"></i> nextGen@gmail.com</li>
			                        </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="contact-form">
                                      ...
                                      <form action ="PAYinsert"  method ="post"role="form"   >
...
  										<input type="radio" id="SINHALA" name="sub" value="SINHALA"> 
										...
										<label for="css">mahats</label><br>
										<input type="radio" id="package" name="sub" value="package"> 
										<label for="css">package</label><br>
                                       </div>
                                        <div class="form-group">
                                            <input type="date" class="form-control input-lg" id="date-picker" name ="paydate" placeholder="Pay date" required >
                                            <script>
var date = new Date();
                    	...
                    	<div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="contact-info">
                                    <h4>Our Address</h4>
                                    <ul class="contact-address">
			                            <li><i class="fa fa-map-marker fa-lg"></i>&nbsp;galewela <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </li>
			                            <li><i class="fa fa-phone"></i>&nbsp; 076 ** ** ***</li>
			                            <li><i class="fa fa-print"></i>&nbsp; 066 ** ** ***</li>
			                            <li><i class="fa fa-envelope"></i> nextGen@gmail.com</li>
