...
public class TeacherDBUtil {
    ...
    public static boolean insertteacher(String tid,String name,String nic,String gender,String subject,String address,String email,String phone,String experience,String eduqualifications,String username,String password) {
    	...
    	try {
    		con = DBConnect.getConnection();
    		stmt = con.createStatement();
    	    String sql = "insert into teacher values ('"+tid+"','"+name+"','"+nic+"','"+gender+"','"+subject+"','"+address+"','"+email+"','"+phone+"','"+experience+"','"+eduqualifications+"','"+username+"','"+password+"')";
    ...
    public static List<Teacher> getTeacherDetails(String tId) {  //getTeacherDetails(String Id)
    ...
    public static boolean deleteTeacher(String tid) { //id
    	
    	//int convId = Integer.parseInt(tid);  //id
