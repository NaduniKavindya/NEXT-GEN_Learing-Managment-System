...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
    ...
    <body data-spy="scroll" data-target="#main-navbar">
		...
		<button  type="submit" name="update" class="btn wow bounceInRight" data-wow-delay="0.4s">Update My Data</button>
		...
		<button type="submit" name="delete" class="btn wow bounceInRight" data-wow-delay="0.4s">Delete My Account</button>
		</a>
			   </div>
	</div>
