...
/**
 * Servlet implementation class MaterialSearchStudentServlet
 */
@WebServlet("/MaterialSearchStudentServlet")
public class MaterialSearchStudentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//response.setContentType("text/html");
				...
				Connection conn = null;
				  ...
				  String query = "select * from materials.materials where materials.material_title like '"+title+"%' or materials.material_title like '%"+title+"' order by materials.id";
