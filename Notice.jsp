...
<html lang="en-US">
    ...
    <body data-spy="scroll" data-target="#main-navbar">
    	...
    	<div class="body">
                  ...
                  <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="page-scroll" href="#contact-section">Notice</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                  </div><!-- /.container -->
                </nav>
			...
			<section id="contact-section" class="page text-white parallax" data-stellar-background-ratio="0.5" style="background-image: url(img/-old-wooden-notice-board.jpg);">
            <div class="cover"></div>
                ...
                <!-- End page header-->
                        ...
                        <div class="contact wow bounceInRight" data-wow-delay="0.4s">
                                ...
                                <div class=" text-center contact-form">
									...
									<form action = "noticeInsert"  method = "post" role="form">
									
						<input type="text" name = "teacher" class="form-control input-lg" placeholder="Your ID" required><br>
						<select name = "grade" class="form-control input-lg" required>
						...
						<textarea Name= "text" class="form-control input-lg" rows="5" placeholder="Message" required></textarea><br>
		
			<button type="submit"  name = "myButton" value = "Insert Notice" class="btn wow bounceInRight" data-wow-delay="0.8s">Submit</button><br><br>
			
		
			<button type="reset" name = "myButton" value="Reset" class="reset-button" class="col-sm-6"  class="btn wow bounceInRight" data-wow-delay="0.8s">Reset</button>
		...
		<br>
         ...
         <form method="post" name="frm2" action="noticeViewAll"><button type="submit" value="View All Notices" class="btn wow bounceInRight" data-wow-delay="0.8s">View All</button></form>                                                                     
