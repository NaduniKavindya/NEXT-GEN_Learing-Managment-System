...
<!--  <td><h4>Package id</h4></td>-->
<td><h4>Package Name</h4></td>
<td><h4>Suggested By</h4></td>
...
String sql ="SELECT * FROM student_info.packages";
...
<td><img src="<%=resultSet.getString("image") %>" style="width:140px;height:170px"></td>
<td><%=resultSet.getString("price") %></td>

<td><a href="payment.jsp" class="btn btn-default" href="#" >Buy</a>
    </td>
</tr>
