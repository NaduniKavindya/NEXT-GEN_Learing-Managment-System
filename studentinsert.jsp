...
<html>
	...
	<form action = "insert" method = "post"  role="form">
		...
		Contact Number :
		<input type = "text" class="form-control input-lg"  name = "contact" required><br><br>
		...
		Contact Number :
		<input type = "text" class="form-control input-lg"  name = "gcontact" required><br><br>
		...
		Password :
		<input type = "password" class="form-control input-lg"  name = "password"  required><br><br>
