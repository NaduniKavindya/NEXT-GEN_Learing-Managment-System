                ...
                <div class="contact wow bounceInRight" data-wow-delay="1.0s">
                    <div class="container">
                        <div class="row">
                                    ...
                                    <form  action ="PAYdelet" method ="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control input-lg" name ="age" value="<%= age %>" required readonly>
                                        </div>
                                        <div class="form-group"> 
                                            <input type="text" class="form-control input-lg" name ="stu" value="<%= stu %>" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control input-lg" name ="grade" value="<%= grade %>" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control input-lg" name ="sub" value="<%= subject%>" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <input type="date" class="form-control input-lg" name ="pay" value="<%= payd %>" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <input type="email" class="form-control input-lg" name ="email" value="<%= email %>" required readonly>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control input-lg" name ="tell" value="<%= tell %>" required readonly>
                                        </div>
                                        <div class="form-group">
                                        
                                         <input type="text" class="form-control input-lg" name ="mg" value="<%= maseg %>" required readonly>
